...
-- noselect: don't auto-select/insert; <CR> stays a newline unless an item is picked
-- popup: show resolved documentation in a popup next to the menu
-- fuzzy: enable fuzzy in-menu filtering (Nvim 0.11+); e.g. `usr` matches `User`
